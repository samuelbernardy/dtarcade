    ...
    marketingTiles: [
      {
        ...
        href: 'https://wkf10640.apps.dynatrace.com/ui/apps/dynatrace.security.vulnerabilities/vulnerabilities',
        posterSrc: './assets/tiles/appsec-poster.png',
        gifSrc: './assets/tiles/appsec.gif',
      },
      {
        id: 'priority',
        title: 'Investigation Scenarios',
        description: 'Hunt threats and more in a data-driven interface with Investigations',
        href: 'https://wkf10640.apps.dynatrace.com/ui/apps/dynatrace.security.investigator/',
      ...
      },
      {
        id: 'automate',
        title: 'Automation',
        description: 'Automate risk mitigation with low-code, easy to manage Workflows!',
        href: 'https://wkf10640.apps.dynatrace.com/ui/apps/dynatrace.hub/browse/all?search=workflows&sortCapabilitiesBy=most-relevant&details=dynatrace.automations',
